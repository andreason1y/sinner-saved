    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-5 py-4 lg:px-8">
        ...
        <Link href="/" className="group flex items-baseline gap-2">
          <span className="serif-display text-[1.7rem] font-normal leading-none text-ink-900 dark:text-ink-50">
            Sinner<span className="font-semibold text-gold-600 dark:text-gold-300">Saved</span>
          </span>
        </Link>
