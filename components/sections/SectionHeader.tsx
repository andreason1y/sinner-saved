  ...
  return (
    ...
    >
      ...
      {href && (
        <Link
          href={href}
          className="group inline-flex items-center gap-2 rounded-full border border-ink-900/15 bg-white/60 px-4 py-2 text-sm text-ink-800 backdrop-blur transition-colors hover:bg-white"
        >
          {hrefLabel}
          <ArrowUpRight
            size={14}
